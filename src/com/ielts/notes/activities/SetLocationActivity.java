...
import com.ielts.notes.map.GPSTracker;
import com.ielts.notes.map.PlaceJSONParser;

public class SetLocationActivity extends FragmentActivity implements OnClickListener, OnItemClickListener{
...
//		break;
		...
		case R.id.current_location_imageView:
			...
			if(enter_location_auto.getText().length() != 0){
				
				LatLng location = getLatLongFromGivenAddress(enter_location_auto.getText().toString());
...
//		LatLng location = getLatLongFromGivenAddress(str);
//		displayLocation(location);
	}

	private LatLng getLatLongFromGivenAddress(String str) {
		// TODO Auto-generated method stub
